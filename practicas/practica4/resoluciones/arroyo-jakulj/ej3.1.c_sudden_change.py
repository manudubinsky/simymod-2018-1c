...
1. Realizar los puntos a), b) y c) del ejercicio 4.3 (pag 113)
    ...
    corresponds to a sudden change in environment at t = t*. Choose C0 = 2*T0,
    C1 = 1/2 * T0, and t* = 3/k. Plot the solution T(t) and explain why it seems
...
def main():
    ...
    # temperatura del rededor: C0 hasta tc, C1 depues
    C0 = 2*T0
    C1 = 0.5*T0
    tc = 3*k
    T_s = lambda t: C0 if t <= tc else C1
